...
@section('content')
    <div class="container">
        ...
        @endif
        <a class="btn btn-info btn-sm float-end" href="{{ url('users/create')}}">Tambah Data</a>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>{{ $row->user_hp}}</td>
                <td><a class="btn btn-dark btn-sm float" href="{{url('users/' .$row->user_id. '/edit')}}">Edit</a></td>
                <td>
